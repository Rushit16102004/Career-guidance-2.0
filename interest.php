      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" id="active" aria-current="page" href="/index.html">HOME</a>
            </li>
            <li class="nav-item">
          ...
          <div class="col-md-12">
            <div class="fluid">
              ...
              <p id="par">
                ...
                <div class="expandable" id="expandableSection">
                  <h2>More Information</h2>
                  <div class="expandable-content">
                    <p>This is the additional content that will be revealed when the section is expanded. You can add more details here.</p>
                  </div>
                </div>
              </p>
            </div>
